          ...
          <Slider className="slide-1 home-slider">
            <div>
              <div
                ...
                style={{
                  backgroundImage: `url("https://images.unsplash.com/photo-1518843875459-f738682238a6?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1026&q=80")`,
                }}
              >
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="slider-contain">
                        <div>
                          <h4>save 10%</h4>
                          <h1 style={{ color: "white" }}>fresh vegetables</h1>
                      ...
                      <div className="classic-effect">
                        <div>
                          <img
                            ...
                            }/assets/images/vegetables/blog/1.jpg`}
                      ...
                      <div className="classic-effect">
                        <div>
                          <img
                            src={`${
                              process.env.PUBLIC_URL
                            }/assets/images/vegetables/blog/2.jpg`}
                            className="img-fluid blur-up lazyload bg-img"
                            alt=""
                          />
                        </div>
                      ...
                      <div className="classic-effect">
                        <div>
                          <img
                            src={`${
                              process.env.PUBLIC_URL
                            }/assets/images/vegetables/blog/3.jpg`}
                            className="img-fluid blur-up lazyload bg-img"
                            alt=""
                          />
                        </div>
                      ...
                      <div className="classic-effect">
                        <div>
                          <img
                            src={`${
                              process.env.PUBLIC_URL
                            }/assets/images/vegetables/blog/4.jpg`}
                            className="img-fluid blur-up lazyload bg-img"
                            alt=""
                          />
                        </div>
